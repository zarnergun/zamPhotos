...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    private static final String textTitle = "NOTIF";
    private static final String TAG = "TOKEN";

    @RequiresApi(api = Build.VERSION_CODES.O)
    private void MyNotify(String textContent) {
        Context context = this;
        Resources res = context.getResources();

        Notification notification = new Notification.Builder(context)
                .setSmallIcon(R.drawable.ic_launcher_foreground)     // drawable for API 26
        ...
        notifManager.notify(Integer.parseInt(CHANNEL_ID), notification );

        Log.i("NOTIF", textContent);
    }
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        if (remoteMessage.getNotification() != null) {
            ...
            //MyNotify(remoteMessage.getNotification().getBody());
